...
<?php else: ?>
    ...
    <?php if (isset($show_when)): ?>
      [?php if (call_user_func(array($<?php echo $this->getSingularName() ?>, '<?php echo $show_when ?>'))): ?]
        [?php if (method_exists($<?php echo $this->getSingularName() ?>->getRawValue(), 'can<?php echo sfInflector::camelize($params['action']) ?>') && $<?php echo $this->getSingularName() ?>->can<?php echo sfInflector::camelize($params['action']) ?>()): ?]
