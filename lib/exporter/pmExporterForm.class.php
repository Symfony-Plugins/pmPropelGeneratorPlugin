...
class pmExporterForm extends sfForm
{
  protected
    $criteria = null,
    $configuration = null,
  ...
  public function getActiveFields()
  {
    if ($this->isBound())
    {
      ...
      foreach ($this->getFields() as $fieldDecorator)
      {
        ...
        {
          $selectedFields[] = $fieldDecorator->getId();
        }
      }
  ...
  public function configure()
  {
    ...
    {
      $this->setWidget('type', new sfWidgetFormChoice(array('choices' => pmExporterTypes::getChoices(true, $this->getContext()))));
      $this->setValidator('type', new sfValidatorChoice(array('choices' => pmExporterTypes::getTypes(), 'required' => true)));
    }
    else
    {
